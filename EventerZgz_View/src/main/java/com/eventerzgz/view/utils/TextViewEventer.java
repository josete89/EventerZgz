...
/**
 * Created by jesus_000 on 18/04/2015.
 */
...
public class TextViewEventer extends TextView {
        ...
        public TextViewEventer(Context context) {
            super(context);
            init();
        }

        public TextViewEventer(Context context, AttributeSet attrs) {
            super(context, attrs);
            init();
        }
